  ...
  render() {
    ...
    return (
      <SafeAreaView
        ...
        {
          this.props.loading ?
            <View style={{ flex: 9, backgroundColor: '', justifyContent: 'center' }}>
        ...
        <Animated.View style={[{ flex: 0.6, backgroundColor: '#edeeef', borderTopColor: '#b7b7b7', borderTopWidth: 0.3, alignItems: 'center', padding: 10, alignItems: 'flex-end' }, animatedStyles]}>
          <Button
            title={'Kayıt ol'}
            onPress={() => this.props.register(this.state.username, this.state.email, this.state.password)
            }
